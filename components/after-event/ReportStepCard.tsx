...
export default function ReportStepCard({ isActive, isCompleted, formData, updateFormData, validationErrors, isSubmitting, completeStep }: ReportStepCardProps) {
  return (
    <Card className={`bg-neutral-900 border-neutral-800 ${!isActive && isCompleted ? "opacity-60" : ""}`}>
      <CardHeader>
        ...
        <CardDescription className="text-gray-400">Provide a comprehensive summary of the event</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label htmlFor="program-type" className="text-white">Program Type *</Label>
          ...
          <div>
            <Label htmlFor="other-program" className="text-white">Other</Label>
            <Input
              id="other-program"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label htmlFor="program-theme" className="text-white">Program Theme *</Label>
          ...
          <div>
            <Label htmlFor="duration" className="text-white">Duration of the activity (in hours) *</Label>
            <Input
              id="duration"
              type="number"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label htmlFor="student-participants" className="text-white">Number of Student Participants (Minimum 50 Students) *</Label>
            <Input
          ...
          <div>
            <Label htmlFor="faculty-participants" className="text-white">Number of Faculty Participants *</Label>
            <Input
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label htmlFor="external-participants" className="text-white">Number of External Participants, if any</Label>
            <Input
          ...
          <div>
            <Label htmlFor="expenditure" className="text-white">Expenditure Amount, if any</Label>
            <Input
              id="expenditure"
              type="number"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label htmlFor="remark" className="text-white">Remark</Label>
            <Textarea
              id="remark"
          ...
          <div>
            <Label htmlFor="session-delivery" className="text-white">Mode of Session delivery *</Label>
        ...
        <div className="border-t border-neutral-700 pt-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="benefits" className="text-white">Benefit in terms of learning/skill/knowledge obtained *</Label>
              <Textarea
                id="benefits"
        ...
        {!isCompleted && (
          <Button onClick={() => completeStep(0)} disabled={isSubmitting} className="bg-orange-400 hover:bg-orange-500 text-white disabled:opacity-50">
