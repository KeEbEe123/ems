    ...
    >
      ...
      <CardContent className="space-y-4">
        <div className="space-y-4">
          <div>
            <Label>Videos/url (Max 200MB)</Label>
            <input
              ref={videoInputRef}
              type="file"
              accept="video/*"
              ...
              {fileUploads.eventVideo ? (
                ...
                <>
                  ...
                  <Button
                    ...
                    className="mt-2 border-neutral-700 hover:bg-neutral-800 bg-transparent text-xs"
                  >
                    Browse
                  </Button>
                </>
          ...
          <div>
            <Label>Photographs * (Max 3 images, 3MB each)</Label>
            <input
              ref={imageInputRef}
              type="file"
              accept="image/*"
          ...
          <div>
            <Label>Upload Report (Word/PDF only) * (Max 200KB)</Label>
            <input
              ref={reportInputRef}
              type="file"
              ...
              {fileUploads.eventReport ? (
                ...
                <>
                  ...
                  <Button
                    ...
                    className="mt-2 border-neutral-700 bg-transparent text-xs"
                  >
                    Browse
                  </Button>
                </>
